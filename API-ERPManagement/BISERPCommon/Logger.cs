...
namespace BISERPCommon
{
    public sealed class Logger
    {
        ...
        class LoggerImpl : ILogger
        {
            ...
            {
                return string.Format("{1} [{2}] {3} ({0})\r\n", msg, DateTime.Now.ToString("dd-MMM-yyyy HH:mm:ss.fff", CultureInfo.InvariantCulture), Thread.CurrentThread.ManagedThreadId, TypeName, logType);
            }
