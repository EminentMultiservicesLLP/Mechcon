            ...
            using (DBHelper dbHelper = new DBHelper())
            {
                ...
                type = dtType.AsEnumerable()
                            .Select(row => new OutsideMaintenanceEntity
                            {
                                ...
                                strScheduledFromDate = Convert.ToDateTime(row.Field<DateTime>("ScheduledFromDate")).ToString("dd-MMM-yyyy"),
                                ScheduledToDate = row.Field<DateTime>("ScheduledToDate"),
                                strScheduledToDate = Convert.ToDateTime(row.Field<DateTime>("ScheduledToDate")).ToString("dd-MMM-yyyy"),
