                ...
                type = dtType.AsEnumerable()
                            .Select(row => new RequestRegisterEntity
                            {
                               ...
                               RequestedDate = row.Field<DateTime>("RequestedDate"),
                                StrRequestedDate = Convert.ToDateTime(row.Field<DateTime>("RequestedDate")).ToString("dd-MMMM-yyyy"),
                                ...
                                StrRequiredDate = Convert.ToDateTime(row.Field<DateTime?>("RequiredDate")).ToString("dd-MMMM-yyyy"),
