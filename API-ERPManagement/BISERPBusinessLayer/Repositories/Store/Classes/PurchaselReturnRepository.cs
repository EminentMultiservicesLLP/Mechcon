...
namespace BISERPBusinessLayer.Repositories.Store.Classes
{
    public class PurchaseReturnRepository : IPurchaseReturnRepository
    {
        ...
        public PurchaseReturnEntity CreatePurchaseReturn(PurchaseReturnEntity entity)
        {
            using (DBHelper dbHelper = new DBHelper())
            {
                DBParameterCollection paramCollection = new DBParameterCollection();
               ...
               // paramCollection.Add(new DBParameter("ReturnedBy", entity.InsertedBy, DbType.Int32));
                ...
                var parameterList = dbHelper.ExecuteNonQueryForOutParameter(StoreQuery.InsPurchaseReturnMaster, paramCollection, null, CommandType.StoredProcedure);
