            ...
            using (DBHelper dbHelper = new DBHelper())
            {
                ...
                type = dtType.AsEnumerable()
                            .Select(row => new ClientRecieptEntiy
                            {
                                ...
                                StrRecieptDate = Convert.ToDateTime(row.Field<DateTime>("RecieptDate")).ToString("dd-MMMM-yyyy"),
            ...
            using (DBHelper dbHelper = new DBHelper())
            {
                ...
                bill = dtpo.AsEnumerable()
                            .Select(row => new ClientBillingEntity
                            {
                                ...
                                StrDueDate = Convert.ToDateTime(row.Field<DateTime>("DueDate")).ToString("dd-MMMM-yyyy"),
