...
namespace BISERPDataLayer.DataAccess
{
    public class DBParameterCollection
    {
        ...
        public DBParameter Get(string parameterKey)
        {
            int? index = _parameterCollection.FindIndex(a => a.Name == parameterKey);
            if (index != null)
                return _parameterCollection[Convert.ToInt16(index)];
            else
                return null;
        }
        /// <summary>
