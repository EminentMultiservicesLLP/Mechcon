...
namespace BISERPDataLayer.DataAccess
{
    /// <summary>
    ...
    public class DBHelper :IDisposable
    {
        ...
        private Dictionary<string, object> ExecuteNonQueryForOutParameter(string commandText, DBParameterCollection paramCollection, IDbTransaction transaction, CommandType commandType)
        {
        ...
        //        transaction.Rollback();
        //        Loggger.LogError("Error in DBHelper class InsertDataUsingSqlBulkCopy method :" + ex.StackTrace);
        //        throw ex;
        //    }
        //}
    }
