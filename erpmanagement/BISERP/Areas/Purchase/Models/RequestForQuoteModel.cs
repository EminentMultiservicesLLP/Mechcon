...
namespace BISERP.Areas.Purchase.Models
{
    public class RequestForQuoteModel
    {
        ...
        public List<RequestForQuoteDetailModel> IndentDetails { get; set; }
        ...
        public List<RFQDeliveryTermModel> RFQDeliveryTerms { get; set; }
        public List<RFQPaymentTermModel> RFQPaymenterms { get; set; }
    ...
    public class RequestForQuoteDetailModel
    {
    ...
    public class RFQPaymentTermModel
    {
