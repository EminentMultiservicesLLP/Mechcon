...
colGRNItemList = [
    ...
    { title: "Item Name", dataIndx: "Name", width: 200, dataType: "string", editable: false, filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] } },
    { title: "HSN/SAC Code", dataIndx: "HSNCode", width: 150, editable: false },
...
colMIItemList = [
    ...
    { title: "Code", dataIndx: "Code", width: '15%', dataType: "string", filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] }},
    { title: "Item Name & Description", dataIndx: "Name", width: '38%', dataType: "string", editable: false, filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] } },
    { title: "Make", dataIndx: "Make", width: '20%', dataType: "string", filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] } },
    { title: "MOC", dataIndx: "MaterialOfConstruct", width: '25%', dataType: "string", filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] } },
    { dataIndx: "ID", hidden: true },
    { dataIndx: "ExpiryDate", hidden: true },
