    ...
    return (function (t) {
        ...
        function (t, n, e) {
            ...
            var u = "http://www.w3.org/1999/xhtml",
                o = { svg: "http://www.w3.org/2000/svg", xhtml: u, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" },
                s = function (t) {
                    var n = (t += ""),
                        e = n.indexOf(":");
                    return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), o.hasOwnProperty(n) ? { space: o[n], local: t } : t;
                };
            var a = function (t) {
                var n = s(t);
                return (n.local
            ...
            var z = {},
                P = null;
            "undefined" != typeof document && ("onmouseenter" in document.documentElement || (z = { mouseenter: "mouseover", mouseleave: "mouseout" }));
            function j(t, n, e) {
                return (
                    (t = W(t, n, e)),
                    function (n) {
            ...
            function R(t, n, e) {
                ...
                return function (r, u, o) {
                    ...
                    this.addEventListener(t.type, h, e), (s = { type: t.type, name: t.name, value: n, listener: h, capture: e }), a ? a.push(s) : (this.__on = [s]);
                };
            }
            function q(t, n, e, i) {
                var r = P;
            ...
            V.prototype = $.prototype = {
                ...
                selectAll: function (t) {
                    ...
                    for (var n = this._groups, e = n.length, i = [], r = [], u = 0; u < e; ++u) for (var o, s = n[u], a = s.length, h = 0; h < a; ++h) (o = s[h]) && (i.push(t.call(o, o.__data__, h, s)), r.push(o));
                    return new V(i, r);
                },
                filter: function (t) {
                    "function" != typeof t && (t = p(t));
                    for (var n = this._groups, e = n.length, i = new Array(e), r = 0; r < e; ++r) for (var u, o = n[r], s = o.length, a = (i[r] = []), h = 0; h < s; ++h) (u = o[h]) && t.call(u, u.__data__, h, o) && a.push(u);
                    return new V(i, this._parents);
                },
                data: function (t, n) {
                    if (!t)
                ...
                order: function () {
                    for (var t = this._groups, n = -1, e = t.length; ++n < e; ) for (var i, r = t[n], u = r.length - 1, o = r[u]; --u >= 0; ) (i = r[u]) && (o && 4 ^ i.compareDocumentPosition(o) && o.parentNode.insertBefore(i, o), (o = i));
                    return this;
                },
                sort: function (t) {
                    function n(n, e) {
                ...
                each: function (t) {
                    for (var n = this._groups, e = 0, i = n.length; e < i; ++e) for (var r, u = n[e], o = 0, s = u.length; o < s; ++o) (r = u[o]) && t.call(r, r.__data__, o, u);
                    return this;
                },
                attr: function (t, n) {
                    var e = s(t);
                ...
                classed: function (t, n) {
                    var e = w(t + "");
                    if (arguments.length < 2) {
                        for (var i = b(this.node()), r = -1, u = e.length; ++r < u; ) if (!i.contains(e[r])) return !1;
                        return !0;
                    }
                    return this.each(
                        ("function" == typeof n
                ...
                on: function (t, n, e) {
                    ...
                    if (s) for (var a, h = 0, c = s.length; h < c; ++h) for (i = 0, a = s[h]; i < o; ++i) if ((r = u[i]).type === a.type && r.name === a.name) return a.value;
                },
            ...
            var U = $,
                X = function (t) {
                    return "string" == typeof t ? new V([[document.querySelector(t)]], [document.documentElement]) : new V([[t]], L);
                },
                Y = 0;
            function G() {
            ...
            var Z = function () {
                ...
                K = function (t, n, e) {
                    ...
                    for (var i, r = 0, u = n ? n.length : 0; r < u; ++r) if ((i = n[r]).identifier === e) return Q(t, i);
                    return null;
                };
            function tt(t, n) {
            ...
            function ut(t, n) {
                ...
                for (null == n && (n = ot); (e = h.pop()); )
                    if ((a && (e.value = +e.data.value), (r = n(e.data)) && (o = r.length))) for (e.children = new Array(o), u = o - 1; u >= 0; --u) h.push((i = e.children[u] = new ht(r[u]))), (i.parent = e), (i.depth = e.depth + 1);
            ...
            ht.prototype = ut.prototype = {
                ...
                each: function (t) {
                    var n,
                        ...
                        o = [u];
                    do {
                        for (n = o.reverse(), o = []; (u = n.pop()); ) if ((t(u), (e = u.children))) for (i = 0, r = e.length; i < r; ++i) o.push(e[i]);
                    } while (o.length);
                    return this;
                },
                eachAfter: function (t) {
                    for (var n, e, i, r = this, u = [r], o = []; (r = u.pop()); ) if ((o.push(r), (n = r.children))) for (e = 0, i = n.length; e < i; ++e) u.push(n[e]);
                    for (; (r = o.pop()); ) t(r);
                    return this;
                },
                eachBefore: function (t) {
                    for (var n, e, i = this, r = [i]; (i = r.pop()); ) if ((t(i), (n = i.children))) for (e = n.length - 1; e >= 0; --e) r.push(n[e]);
                    return this;
                },
                sum: function (t) {
            ...
            function ft(t, n) {
                var e, i;
                if (dt(n, t)) return [n];
                for (e = 0; e < t.length; ++e) if (pt(n, t[e]) && dt(gt(t[e], n), t)) return [t[e], n];
                for (e = 0; e < t.length - 1; ++e) for (i = e + 1; i < t.length; ++i) if (pt(gt(t[e], t[i]), n) && pt(gt(t[e], n), t[i]) && pt(gt(t[i], n), t[e]) && dt(vt(t[e], t[i], n), t)) return [t[e], t[i], n];
                throw new Error();
            }
            function pt(t, n) {
                var e = t.r - n.r,
            ...
            function gt(t, n) {
                var e = t.x,
                    ...
                    c = s - r,
                    l = Math.sqrt(a * a + h * h);
                return { x: (e + u + (a / l) * c) / 2, y: (i + o + (h / l) * c) / 2, r: (l + r + s) / 2 };
            }
            function vt(t, n, e) {
                var i = t.x,
                    r = t.y,
            ...
            function mt(t, n, e) {
                ...
                h
                    ? ((r = n.r + e.r),
                      ...
                      (o = t.r + e.r),
                      r > (o *= o)
                          ? ((i = (h + o - r) / (2 * h)), (u = Math.sqrt(Math.max(0, o / h - i * i))), (e.x = t.x - i * s - u * a), (e.y = t.y - i * a + u * s))
                          : ((i = (h + r - o) / (2 * h)), (u = Math.sqrt(Math.max(0, r / h - i * i))), (e.x = n.x + i * s - u * a), (e.y = n.y + i * a + u * s)))
                    : ((e.x = n.x + e.r), (e.y = n.y));
            }
            function xt(t, n) {
                var e = t.r + n.r - 1e-6,
            ...
            function bt(t) {
                ...
                t: for (s = 3; s < r; ++s) {
                    ...
                    for (i.previous = n, i.next = e, n.next = e.previous = e = i, u = At(n); (i = i.next) !== e; ) (o = At(i)) < u && ((n = i), (u = o));
                    e = n.next;
                }
            ...
            var Yt = function () {
                    ...
                    function r(r) {
                        var a = (function (t) {
                            for (var n, e, i, r, u, o = new Xt(t, 0), s = [o]; (n = s.pop()); )
                                if ((i = n._.children)) for (n.children = new Array((u = i.length)), r = u - 1; r >= 0; --r) s.push((e = n.children[r] = new Xt(i[r], r))), (e.parent = n);
                    ...
                    function u(n) {
                        ...
                        n.parent.A = (function (n, e, i) {
                            if (e) {
                                for (var r, u = n, o = n, s = e, a = u.parent.children[0], h = u.m, c = o.m, l = s.m, f = a.m; (s = Vt(s)), (u = Lt(u)), s && u; )
                                    (a = Lt(a)), ((o = Vt(o)).a = n), (r = s.z + l - u.z - h + t(s._, u._)) > 0 && ($t(Ut(s, n, i), n, r), (h += r), (c += r)), (l += s.m), (h += u.m), (f += a.m), (c += o.m);
            ...
            function Qt(t, n, e, i, r, u) {
                for (var o, s, a, h, c, l, f, p, _, d, y, g = [], v = n.children, m = 0, x = 0, A = v.length, w = n.value; m < A; ) {
                    ...
                    g.push((o = { value: c, dice: a < h, children: v.slice(m, x) })), o.dice ? Nt(o, e, i, r, w ? (i += (h * c) / w) : u) : Gt(o, e, i, w ? (e += (a * c) / w) : r, u), (w -= c), (m = x);
                }
                return g;
            }
            var Jt = (function t(n) {
                ...
                Kt = function () {
                    ...
                    function l(n) {
                        ...
                        l < i && (i = l = (i + l) / 2),
                            ...
                            (n.x1 = l),
                            (n.y1 = f),
                            n.children && ((e = r[n.depth + 1] = u(n) / 2), (i += h(n) - e), (c += o(n) - e), (l -= s(n) - e) < i && (i = l = (i + l) / 2), (f -= a(n) - e) < c && (c = f = (c + f) / 2), t(n, i, c, l, f));
                    }
                    return (
                        (c.round = function (t) {
            ...
            function sn(t, n) {
                for (var e, i = 0, r = t.length; i < r; ++i) if ((e = t[i]).name === n) return e.value;
            }
            function an(t, n, e) {
            ...
            on.prototype = un.prototype = {
                ...
                on: function (t, n) {
                    ...
                    for (; ++o < s; ) if ((e = (t = u[o]).type) && (e = sn(r[e], t.name))) return e;
                },
                copy: function () {
                    var t = {},
                        n = this._;
                ...
                call: function (t, n) {
                    if ((e = arguments.length - 2) > 0) for (var e, i, r = new Array(e), u = 0; u < e; ++u) r[u] = arguments[u + 2];
            ...
            function fn(t, n) {
                ...
                n &&
                    ...
                    "onselectstart" in e ? i.on("selectstart.drag", null) : ((e.style.MozUserSelect = e.__noselect), delete e.__noselect);
            }
            ...
            function Fn(t) {
                ...
                return (
                    ...
                    (n = xn.exec(t))
                        ? new Nn((((n = parseInt(n[1], 16)) >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1)
                        : (n = An.exec(t))
                        ? Sn(parseInt(n[1], 16))
                        : (n = wn.exec(t))
                        ...
                        ? Mn(n[1], n[2], n[3], n[4])
                        : (n = Bn.exec(t))
                        ? Mn((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
                        : (n = Cn.exec(t))
                ...
                return 1 === arguments.length
                    ? (function (t) {
                          ...
                          var n = (t = t.rgb()).r / 255,
                              ...
                              s = u - r,
                              a = (u + r) / 2;
                          return s ? ((o = n === u ? (e - i) / s + 6 * (e < i) : e === u ? (i - n) / s + 2 : (n - e) / s + 4), (s /= a < 0.5 ? u + r : 2 - u - r), (o *= 60)) : (s = a > 0 && a < 1 ? 0 : o), new Wn(o, s, a, t.opacity);
                      })(t)
            ...
            _n(yn, Fn, {
                ...
                _n(
                    ...
                    dn(yn, {
                        brighter: function (t) {
                            return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Nn(this.r * t, this.g * t, this.b * t, this.opacity);
                        },
                        darker: function (t) {
                            return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Nn(this.r * t, this.g * t, this.b * t, this.opacity);
                        },
                        rgb: function () {
                            return this;
                        },
                ...
                _n(
                    ...
                    dn(yn, {
                        brighter: function (t) {
                            return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Wn(this.h, this.s, this.l * t, this.opacity);
                        },
                        darker: function (t) {
                            return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Wn(this.h, this.s, this.l * t, this.opacity);
                        },
                        rgb: function () {
            ...
            function Gn(t) {
                ...
                return (
                    r === u && u === o ? (e = i = s) : ((e = Jn((0.4360747 * r + 0.3850649 * u + 0.1430804 * o) / In)), (i = Jn((0.0139322 * r + 0.0971045 * u + 0.7141733 * o) / Vn))),
            ...
            _n(
                ...
                dn(yn, {
                    ...
                    rgb: function () {
                        ...
                        return new Nn(
                            te(3.1338561 * (n = In * Kn(n)) - 1.6168667 * (t = Ln * Kn(t)) - 0.4906146 * (e = Vn * Kn(e))),
            ...
            _n(
                ...
                dn(yn, {
                    brighter: function (t) {
                        return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new pe(this.h, this.s, this.l * t, this.opacity);
                    },
                    darker: function (t) {
                        return (t = null == t ? 0.7 : Math.pow(0.7, t)), new pe(this.h, this.s, this.l * t, this.opacity);
                    },
                    rgb: function () {
            ...
            var Be,
                ...
                Fe = function (t, n) {
                    ...
                    for (t += "", n += ""; (e = be.exec(t)) && (i = Ee.exec(n)); )
                        (r = i.index) > u && ((r = n.slice(u, r)), s[o] ? (s[o] += r) : (s[++o] = r)), (e = e[0]) === (i = i[0]) ? (s[o] ? (s[o] += i) : (s[++o] = i)) : ((s[++o] = null), a.push({ i: o, x: we(e, i) })), (u = Ee.lastIndex);
                    return (
                        u < n.length && ((r = n.slice(u)), s[o] ? (s[o] += r) : (s[++o] = r)),
                        s.length < 2
                            ? a[0]
                                ? (function (t) {
                                      return function (n) {
                ...
                Se = 180 / Math.PI,
                Me = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 },
                Te = function (t, n, e, i, r, u) {
                    ...
                    return (
                        ...
                        { translateX: r, translateY: u, rotate: Math.atan2(n, t) * Se, skewX: Math.atan(a) * Se, scaleX: o, scaleY: s }
                    );
                };
            function Oe(t, n, e, i) {
                function r(t) {
                ...
                return function (u, o) {
                    ...
                    return (
                        ...
                        (function (t, n, e, u) {
                            t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), u.push({ i: e.push(r(e) + "rotate(", null, i) - 2, x: we(t, n) })) : n && e.push(r(e) + "rotate(" + n + i);
                        })(u.rotate, o.rotate, s, a),
                        (function (t, n, e, u) {
                            t !== n ? u.push({ i: e.push(r(e) + "skewX(", null, i) - 2, x: we(t, n) }) : n && e.push(r(e) + "skewX(" + n + i);
                        })(u.skewX, o.skewX, s, a),
            ...
            var Ne = Oe(
                    function (t) {
                        return "none" === t
                            ? Me
                            : (Be || ((Be = document.createElement("DIV")), (Ce = document.documentElement), (De = document.defaultView)),
                              (Be.style.transform = t),
                              (t = De.getComputedStyle(Ce.appendChild(Be), null).getPropertyValue("transform")),
                              Ce.removeChild(Be),
                              (t = t.slice(7, -1).split(",")),
                ...
                ze = Oe(
                    function (t) {
                        return null == t
                            ? Me
                            : (ke || (ke = document.createElementNS("http://www.w3.org/2000/svg", "g")), ke.setAttribute("transform", t), (t = ke.transform.baseVal.consolidate()) ? ((t = t.matrix), Te(t.a, t.b, t.c, t.d, t.e, t.f)) : Me);
                    },
                    ", ",
                    ")",
                    ")"
                    ...
                    (i = (g - y) / Pe),
                        (e = function (t) {
                            var n,
                                ...
                                a =
                                    (o / (2 * p)) *
                                    (s * ((n = Pe * e + y), ((n = Math.exp(2 * n)) - 1) / (n + 1)) -
                                        (function (t) {
                                            return ((t = Math.exp(t)) - 1 / t) / 2;
                                        })(y));
            ...
            var oi = function (t, n, e) {
                ...
                yi = function (t, n, e, i, r, u) {
                    ...
                    })(t, e, { name: n, index: i, group: r, on: si, tween: ai, time: u.time, delay: u.delay, duration: u.duration, ease: u.ease, timer: null, state: hi });
                };
            function gi(t, n) {
                var e = mi(t, n);
            ...
            var xi = function (t, n) {
                ...
                if (u) {
                    for (r in ((n = null == n ? null : n + ""), u))
                        (e = u[r]).name === n ? ((i = e.state > li && e.state < _i), (e.state = di), e.timer.stop(), i && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete u[r]) : (o = !1);
            ...
            Bi.prototype = Ci.prototype = {
                ...
                select: function (t) {
                    ...
                    for (var i = this._groups, r = i.length, u = new Array(r), o = 0; o < r; ++o)
                        for (var s, a, h = i[o], l = h.length, f = (u[o] = new Array(l)), p = 0; p < l; ++p)
                            (s = h[p]) && (a = t.call(s, s.__data__, p, h)) && ("__data__" in s && (a.__data__ = s.__data__), (f[p] = a), yi(f[p], n, e, p, f, mi(s, e)));
                ...
                transition: function () {
                    for (var t = this._name, n = this._id, e = Di(), i = this._groups, r = i.length, u = 0; u < r; ++u)
                        for (var o, s = i[u], a = s.length, h = 0; h < a; ++h)
                            if ((o = s[h])) {
                                var c = mi(o, n);
                                yi(o, t, e, h, s, { time: c.time + c.delay + c.duration, delay: 0, duration: c.duration, ease: c.ease });
                            }
                ...
                tween: function (t, n) {
                    ...
                    if (((t += ""), arguments.length < 2)) {
                        for (var i, r = mi(this.node(), e).tween, u = 0, o = r.length; u < o; ++u) if ((i = r[u]).name === t) return i.value;
                        return null;
                    }
                    return this.each(
                        (null == n
                            ...
                            : function (t, n, e) {
                                  ...
                                  return function () {
                                      ...
                                      if (o !== i) {
                                          r = (i = o).slice();
                                          for (var s = { name: n, value: e }, a = 0, h = r.length; a < h; ++a)
                                              if (r[a].name === n) {
                                                  r[a] = s;
                                                  break;
                                              }
            ...
            function Mi(t, n) {
                for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return (Si.time = Ke()), Si;
                return e;
            }
            (U.prototype.interrupt = function (t) {
                ...
                (U.prototype.transition = function (t) {
                    ...
                    for (var i = this._groups, r = i.length, u = 0; u < r; ++u) for (var o, s = i[u], a = s.length, h = 0; h < a; ++h) (o = s[h]) && yi(o, t, n, h, s, e || Mi(o, n));
            ...
            var $i = function () {
                    ...
                    function A(t, n) {
                        for (var e, i = 0, r = l.length; i < r; ++i) if ((e = l[i]).that === t) return e;
                        return new w(t, n);
                    }
                    function w(t, n) {
                    ...
                    function b() {
                        if (e.apply(this, arguments)) {
                            ...
                            Wi(),
                                ...
                                t.zoom("mouse", r(v(g(n, i), t.mouse[0], t.mouse[1]), t.extent, a));
                        }
                    }
                    function E() {
                    ...
                    function D() {
                        ...
                        for (Wi(), t && (t = clearTimeout(t)), n = 0; n < h; ++n)
                            (e = s[n]), (i = K(this, s, e.identifier)), o.touch0 && o.touch0[2] === e.identifier ? (o.touch0[0] = i) : o.touch1 && o.touch1[2] === e.identifier && (o.touch1[0] = i);
                    ...
                    function k() {
                        ...
                        for (
                            ...
                            (e = r[t]), i.touch0 && i.touch0[2] === e.identifier ? delete i.touch0 : i.touch1 && i.touch1[2] === e.identifier && delete i.touch1;
                    ...
                    return (
                        ...
                        (y.translateExtent = function (t) {
                            return arguments.length
                                ? ((a[0][0] = +t[0][0]), (a[1][0] = +t[1][0]), (a[0][1] = +t[0][1]), (a[1][1] = +t[1][1]), y)
                                : [
                                      [a[0][0], a[0][1]],
                                      [a[1][0], a[1][1]],
                                  ];
            ...
            Gi.prototype = Zi.prototype = {
                ...
                arc: function (t, n, e, i, r, u) {
                    ...
                    null === this._x1 ? (this._ += "M" + a + "," + h) : (Math.abs(this._x1 - a) > 1e-6 || Math.abs(this._y1 - h) > 1e-6) && (this._ += "L" + a + "," + h),
                        e &&
                            (l < 0 && (l = (l % Xi) + Xi),
                            l > Yi
                                ? (this._ += "A" + e + "," + e + ",0,1," + c + "," + (t - o) + "," + (n - s) + "A" + e + "," + e + ",0,1," + c + "," + (this._x1 = a) + "," + (this._y1 = h))
                                : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Ui) + "," + c + "," + (this._x1 = t + e * Math.cos(r)) + "," + (this._y1 = n + e * Math.sin(r))));
                },
            ...
            function Sr(t, n, e) {
                var i = t._x1 - t._x0,
                    ...
                    o = (e - t._y1) / (r || (i < 0 && -0)),
                    s = (u * r + o * i) / (i + r);
                return (Fr(u) + Fr(o)) * Math.min(Math.abs(u), Math.abs(o), 0.5 * Math.abs(s)) || 0;
            }
            function Mr(t, n) {
                var e = t._x1 - t._x0;
                ...
                (Pr.prototype = {
                    ...
                    lineEnd: function () {
                        ...
                        if (e)
                            ...
                            else for (var i = jr(t), r = jr(n), u = 0, o = 1; o < e; ++u, ++o) this._context.bezierCurveTo(i[0][u], r[0][u], i[1][u], r[1][u], t[o], n[o]);
            ...
            var Rr = (function (t) {
                ...
                qr = function (t, n) {
                    n = Object.assign({ "font-size": 10, "font-family": "sans-serif", "font-style": "normal", "font-weight": 400, "font-variant": "normal" }, n);
                    ...
                    return (
                        ...
                        i.push("string" == typeof n["font-size"] ? n["font-size"] : n["font-size"] + "px"),
            ...
            var eu = function (t, n) {
                    var e,
                        ...
                        u = -1;
                    if (null == n) {
                        for (; ++u < r; ) if (null != (e = t[u]) && e >= e) for (i = e; ++u < r; ) null != (e = t[u]) && e > i && (i = e);
                    } else for (; ++u < r; ) if (null != (e = n(t[u], u, t)) && e >= e) for (i = e; ++u < r; ) null != (e = n(t[u], u, t)) && e > i && (i = e);
                    return i;
                },
                iu = function (t) {
                    for (var n, e, i, r = t.length, u = -1, o = 0; ++u < r; ) o += t[u].length;
                    for (e = new Array(o); --r >= 0; ) for (n = (i = t[r]).length; --n >= 0; ) e[--o] = i[n];
                    return e;
                },
                ru = function (t, n) {
                    var e,
                        ...
                        u = -1;
                    if (null == n) {
                        for (; ++u < r; ) if (null != (e = t[u]) && e >= e) for (i = e; ++u < r; ) null != (e = t[u]) && i > e && (i = e);
                    } else for (; ++u < r; ) if (null != (e = n(t[u], u, t)) && e >= e) for (i = e; ++u < r; ) null != (e = n(t[u], u, t)) && i > e && (i = e);
                    return i;
                },
                uu = function (t, n) {
                    var e,
                    ...
                    var i = n[0],
                        r = function (e) {
                            ...
                            Object.keys(r).forEach(function (n) {
                                var e,
                                    u = r[n];
                                su(u) && ((e = u), "undefined" == typeof window || (e !== window && e !== document))
                ...
                Fu = (function (t) {
                    function n() {
                        ...
                        t.call(this),
                            ...
                            (this._fontFamily = _u(["Roboto", "Helvetica Neue", "HelveticaNeue", "Helvetica", "Arial", "sans-serif"])),
                            (this._fontMax = _u(50)),
                            (this._fontMin = _u(8)),
                        ...
                        (n.prototype.render = function (t) {
                                ...
                                i = this._select.selectAll(".d3plus-textBox").data(
                                    this._data.reduce(function (t, i, r) {
                                        ...
                                        var o,
                                            ...
                                            _ = 1,
                                            d = [],
                                            y = { "font-family": Gr(n._fontFamily(i, r)), "font-size": f, "font-weight": n._fontWeight(i, r), "line-height": p },
                                            g =
                                                ((a = n._padding(i, r)),
                                                1 === (h = "number" == typeof a ? [a] : a.split(/\s+/)).length ? (h = [h[0], h[0], h[0], h[0]]) : 2 === h.length ? (h = h.concat(h)) : 3 === h.length && h.push(h[1]),
                                                ["top", "right", "bottom", "left"].reduce(function (t, n, e) {
                                            ...
                                            x = (function () {
                                                ...
                                                function h(h) {
                                                    ...
                                                    for (
                                                        var c = s(h), l = { "font-family": n, "font-size": e, "font-weight": i, "line-height": t }, f = 1, p = "", _ = !1, d = 0, y = [], g = qr(c, l), v = qr(" ", l), m = 0;
                                                        m < c.length;
                                                        m++
                                                    ) {
                                                        var x = c[m],
                                                    ...
                                                    return { lines: y, sentence: h, truncated: _, widths: qr(y, l), words: c };
                                                }
                                                return (
                                        ...
                                        if (m > w && (v > p || (c && v > w * l))) {
                                            ...
                                            !(function t() {
                                                ...
                                                if (
                                                    ((f = eu([f, w])),
                                                    (f = ru([f, A])),
                                                    c && ((p = f * l), x.fontSize(f).lineHeight(p), (y["font-size"] = f), (y["line-height"] = p)),
                                                    (s = x(u)),
                            ...
                            function u(t) {
                                t.attr("transform", function (t, n) {
                                    ...
                                    return "translate(" + t.x + ", 19"/* + t.y*/ + ") rotate(" + t.r + ", " + i[0] + ", " + i[1] + ")";
                                });
                            }
                                ...
                                .each(function (t) {
                                    function n(n) {
                                        n.text(function (t) {
                                            ...
                                            .attr("x", ("middle" === t.tA ? t.w / 2 : s ? ("start" === t.tA ? t.w : 0) : "end" === t.tA ? t.w : 2 * Math.sin((Math.PI * t.r) / 180)) + "px")
                                            .attr("y", function (n, e) {
                                                return 0 === t.r || "top" === t.vA
                                                    ? (e + 1) * t.lH - (t.lH - t.fS) + "px"
                                                    : "middle" === t.vA
                                                    ? (t.h + t.fS) / 2 - (t.lH - t.fS) + (e - t.lines.length / 2 + 0.5) * t.lH + "px"
                                                    : t.h - 2 * (t.lH - t.fS) - (t.lines.length - (e + 1)) * t.lH + 2 * Math.cos((Math.PI * t.r) / 180) + "px";
                                            });
                                    }
                                    ...
                                    0 === e._duration
                                        ? (i.call(n),
                                          i.exit().remove(),
                                          i.enter().append("text").attr("dominant-baseline", "alphabetic").style("baseline-shift", "0%").attr("unicode-bidi", "bidi-override").call(n).attr("opacity", t.fO).style("opacity", t.fO))
            ...
            Tu.defaults = { sizingMode: "size", horizontalSpacing: 15, verticalSpacing: 20 };
            var Ou = Tu;
            function Nu(t, n, e) {
                return n in t ? Object.defineProperty(t, n, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : (t[n] = e), t;
            }
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return (
                                    ...
                                    "nodesize" === e ? (this.getTreeGenerator().nodeSize(this._getNodeSize()), !1 === this.getAllowFocus() && (n = !0)) : this.getTreeGenerator().size([this.getHeight(), this.getWidth()]),
                                    !1 === n
                                        ? (this.getView().attr("transform", "translate(" + t.left + "," + t.top + ")"), (this.getRoot().x0 = this.getHeight() / 2))
                                        : (this.getView().attr("transform", "translate(" + t.left + ", " + (this.getHeight() / 2 + this.getMargin().top) + ")"), (this.getRoot().x0 = 0)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return (
                                    ...
                                    (this._panningContainer = this.getView().append("g").classed("panningContainer", !0)),
                                    ...
                                    !1 === this.getAllowPan() && this.getSvg().on("mousedown.zoom", null).on("touchstart.zoom", null).on("touchmove.zoom", null).on("touchend.zoom", null),
                                    !1 === this.getAllowZoom() && this.getSvg().on("dblclick.zoom", null).on("wheel.zoom", null),
                                    this.updateDimensions(),
                                    this._populateUnderlyingChildren(this.getRoot()),
                                    this.getRoot().children && this.getRoot().children.forEach(this.collapseRecursively),
                                    this.removeSelection(this.getRoot()),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ...
                                    this._updateNodes(t, this.getVisibleNodes())._updateLinks(t, this.getLinks()),
                                    this
                                );
                            },
                        },
            ...
            Iu.defaults = {
                ...
                getParentId: null,
                getChildren: null,
                widthWithoutMargin: 1020,
                heightWithoutMargin: 980,
            ...
            var Zu = (function (t) {
                ...
                return (
                    (function (t, n) {
                        ...
                        (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && Gu(t, n);
                    })(n, Ou),
                    (e = n),
                    (i = [
                        {
            ...
            Zu.defaults = { bodyBoxWidth: 150, bodyBoxHeight: 50, bodyBoxPadding: { top: 3, right: 5, bottom: 3, left: 5 }, titleBoxWidth: null, titleBoxHeight: 25, titleBoxPadding: { top: 2, right: 3, bottom: 2, left: 3 } };
            var Qu = Zu;
            function Ju(t) {
                return (Ju =
                    "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ...
            var uo = (function (t) {
                function n(t) {
                    ...
                    !(function (t, n) {
                        ...
                        (i = this),
                        (e = !(r = eo(n).call(this, t)) || ("object" !== Ju(r) && "function" != typeof r) ? ro(i) : r);
                    var u = (function (t) {
                        for (var n = 1; n < arguments.length; n++) {
                            var e = null != arguments[n] ? arguments[n] : {},
                                i = Object.keys(e);
                ...
                return (
                    (function (t, n) {
                        if ("function" != typeof n && null !== n) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && io(t, n);
                    })(n, Lu),
                    (e = n),
                    (i = [
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t, n) {
                                ...
                                return (
                                    ...
                                    h.append("rect").classed("body-box", !0).attr("width", 1e-6).attr("height", 1e-6),
                                    ...
                                    t
										...
										.attr("transform", "translate(" + -o / 3 + ", " + (-s / 2 - r / 2) + ")")
                                        .each(function (t, n, i) {
											var clss = "NoLevelTitle";
											if(t.data)
											{ switch(t.data.type)
												{
													case "Root":
														...
														break;
													case "Type":
														clss = "FirstLevelTitle";
														break;
													case "Family":
														clss = "SecondLevelTitle";
														break;
													case "Organism":
														clss = "ThirdLevelTitle";
														break;
													default:
														clss ="NoLevelTitle";
                                            ...
                                            if (e.getTitleDisplayText.call(e, t)) {
                                                var r = Rr.select(this),
                                                    u = [];
                                                u.push(t), r.append("rect").classed("title-box clss", !0).attr("width", o).attr("height", s);
                                                new Fu()
                                                    .select(this)
                                                    .data(u)
                                                    .text(function (t, n, i) {
                            ...
                            value: function (t, n, e) {
                                ...
                                return (
                                    n
                                        ...
                                        .remove(),
                                    n.select(".node .body-group rect").attr("width", 1e-6).attr("height", 1e-6),
                                    n
                                        ...
                                        .attr("y", 0)
                                        .attr("x", 0),
                                    n.select(".node .title-group").attr("transform", "translate(0, " + -r / 2 + ")"),
                                    n.select(".node .title-group rect").attr("width", 1e-6).attr("height", 1e-6),
                                    n.select(".node .title-group .d3plus-textBox").style("fill-opacity", 1e-6).attr("transform", "translate(0,0)").selectAll("text").style("font-size", 0).attr("y", 0).attr("x", 0),
            ...
            var lo = (function (t) {
                ...
                return (
                    (function (t, n) {
                        if ("function" != typeof n && null !== n) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && co(t, n);
                    })(n, Ou),
                    n
                );
            })();
            ...
            var xo = (function (t) {
                function n(t) {
                    ...
                    !(function (t, n) {
                        ...
                        (i = this),
                        (e = !(r = go(n).call(this, t)) || ("object" !== fo(r) && "function" != typeof r) ? mo(i) : r);
                    var u = (function (t) {
                        for (var n = 1; n < arguments.length; n++) {
                            var e = null != arguments[n] ? arguments[n] : {},
                                i = Object.keys(e);
                ...
                return (
                    (function (t, n) {
                        if ("function" != typeof n && null !== n) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && vo(t, n);
                    })(n, Lu),
                    (e = n),
                    (i = [
                        {
